...
def seeded_businesses():
  demo_businesses = [
    ...
    Business(
      owner_id=1, name="2 Bros Pizza", address="72 Nassau St", description="DOLLAR SLICES!", url="https://www.2brospizza.com", phone='5024988420', state="New York", city="Brooklyn", zipcode=10028, open_time=time(hour=8), close_time=time(hour=17), preview_image="https://s3-media0.fl.yelpcdn.com/bphoto/rNvm9HBRdwJESbObUT2FKQ/o.jpg"
    ),
    Business(
      owner_id=1, name="Roberta’s", address="6 Grand St", description="Known for our pepperoni slice!", url="https://www.robertaspizza.com", phone='5024988420', state="New York", city="New York", zipcode=10003, open_time=time(hour=8), close_time=time(hour=17), preview_image="https://s3-media0.fl.yelpcdn.com/bphoto/rdK-sou4FgwoUAy1FFRBCw/o.jpg"
    ),
    Business(
      owner_id=1, name="Grimaldi's Pizzeria", address="1 Front St", description="Best Pizza Place", url="http://grimaldispizzeria.com", phone='3476876910', state="New York", city="Brooklyn", zipcode=11201, open_time=time(hour=8), close_time=time(hour=17), preview_image="https://s3-media0.fl.yelpcdn.com/bphoto/Rxz04yxreCJcr9Wmu0LUSA/o.jpg"
    ),
    Business(
      owner_id=1, name="Lombardo's of Bay Ridge", address="279 71st Ste", description="Brooklyn Style Pizza!", url="https://lombardos-of-bay-ridge.business.site/", phone='7182387100', state="New York", city="Brooklyn", zipcode='11209', open_time=time(hour=8), close_time=time(hour=17), preview_image=""
    ),
    Business(
    ...
    Business(
      owner_id=1, name="Roberta's", address="261 Moore St", description="Pizzas -- Lots of them", url="https://www.robertaspizza.com/", phone='7184171118', state="New York", city="Brooklyn", zipcode=11206, open_time=time(hour=8), close_time=time(hour=17), preview_image="https://s3-media0.fl.yelpcdn.com/bphoto/abL53M6hw-6qRyxD0qijxg/o.jpg"
    ),
    Business(
      owner_id=1, name="Salsa Pizzeria", address="40 Clifford Pl", description="Best pizza ever!", url="https://www.salsapizzeria.com/", phone='3475424680', state="New York", city="Brooklyn", zipcode=11222, open_time=time(hour=8), close_time=time(hour=17), preview_image="https://s3-media0.fl.yelpcdn.com/bphoto/ssjYUXaAYEZuw2fYqA12zg/o.jpg"
    ),
    Business(
      owner_id=1, name="Dellarocco's Brick Oven Pizza", address="214 Hicks St ", description="Famous for serving authentic wood fired Neapolitan pizzas", url="https://www.dellaroccospizza.com/", phone='(718) 858-1010', state="New York", city="New York", zipcode=10003, open_time=time(hour=8), close_time=time(hour=17), preview_image="https://s3-media0.fl.yelpcdn.com/bphoto/RGsip2vQXryVUbOrXfYBkQ/o.jpg"
    ),
    Business(
      owner_id=1, name="Giordano's", address="130 E Randolph", description="Famous Stuffed Pizza", url="http://giordanos.com", phone='3126161200', state="Chicago", city="Randolph", zipcode=60601, open_time=time(hour=8), close_time=time(hour=17), preview_image="https://s3-media0.fl.yelpcdn.com/bphoto/OalRgOyfThOHIqY5A83_fQ/o.jpg"
    ),
    Business(
